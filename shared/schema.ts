...
export const picklistItems = pgTable("picklist_items", {
  ...
  // Note: picklist_order_detail_unique_idx is created at startup (server/routes.ts)
  // after deduplicating existing rows — managed outside Drizzle to avoid migration conflicts.
