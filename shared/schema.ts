...
export const appSettings = pgTable("app_settings", {
  ...
  channelSyncMode: text("channel_sync_mode").default('analysis').notNull(), // 'analysis' = read-only compare only, 'full_control' = create + update, 'quantity_only' = update existing only
