...
export default function InventoryDashboard({ onItemClick, activeDrawer, onDrawerChange, onOpenSettings, desktopMode, onBrowseOpen }: InventoryDashboardProps) {
  ...
  return (
      ...
      <div className={cn("space-y-3")}>
        ...
        <div className="relative rounded-lg border border-amber-500/25 bg-gradient-to-b from-amber-950/25 to-gray-900/70 overflow-hidden" data-testid="section-command-central-inventory">
