...
import { Send, RefreshCcw, Minimize2, Maximize2, ExternalLink, Sparkles, Brain, ChevronDown, ChevronRight, Globe, MessageSquare, Headphones, Lightbulb, Plus, History, Trash2, X, ThumbsUp, Check } from "lucide-react";
