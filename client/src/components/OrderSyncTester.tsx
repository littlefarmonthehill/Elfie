            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    <label className="text-sm md:text-base lg:text-lg font-medium text-muted-foreground mb-1 block">
                      Platform
                    </label>
                ...
                <div className="text-sm md:text-base lg:text-lg text-muted-foreground bg-muted/30 p-3 rounded">
