  ...
  return (
    <div className={`flex items-center gap-1.5 md:gap-3 lg:gap-4 ${className}`}>
      <div className="flex items-center gap-1 md:gap-2 lg:gap-2.5">
        ...
        <span className="text-sm md:text-base md:text-sm lg:text-base font-bold text-gray-400">TIME RANGE</span>
      </div>
      <div className="flex gap-1 md:gap-2 lg:gap-2.5">
        {options.map((option) => (
          <button
            ...
            className={`text-sm md:text-base md:text-sm lg:text-base font-bold py-1 md:py-1.5 lg:py-2 px-1.5 md:px-3 lg:px-4 rounded transition-all ${
              value === option.value
