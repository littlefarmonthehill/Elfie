  ...
  return (
          ...
          <div className="flex items-stretch gap-3" data-testid="directive-workflow-grid">
            ...
            <div className="flex-1 relative pt-1 pb-1.5 flex flex-col gap-1.5">
              ...
              <div className="relative">
                ...
                <div className="flex items-start">
                  {/* Red divider — left marker for exception zone */}
                  <div className="self-stretch relative px-1.5 shrink-0">
      ...
      {(!tvSplit || tvSplit === 'right') && <>
        ...
        <div className={cn("relative rounded-lg border border-gray-600/55 bg-gradient-to-b from-gray-800/50 to-gray-900/92 shadow-[0_3px_0_rgba(0,0,0,0.45),0_0_10px_rgba(255,255,255,0.04)]", isCompact ? "p-2" : "p-1 md:p-2.5")} data-testid="section-panel-tabs">
          ...
          {/* STATION — Tools grid */}
          {panelTab === 'systems' && (
          <div className={cn("relative rounded-lg border border-gray-600/55 bg-gradient-to-b from-gray-800/50 to-gray-900/92 shadow-[0_3px_0_rgba(0,0,0,0.45),0_0_10px_rgba(255,255,255,0.04)] grid grid-cols-2", isCompact ? "gap-1.5 p-2" : "gap-2 p-2")} data-testid="section-order-tools">
          <div className="absolute top-0 left-0 right-0 h-[2px] rounded-t-lg bg-gradient-to-r from-transparent via-gray-500/30 to-transparent" />
