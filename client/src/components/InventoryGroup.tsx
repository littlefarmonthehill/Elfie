      ...
      {isExpanded && (
        <div className="px-3 pb-3">
          ...
          <div className="grid grid-cols-[14px_80px_1fr] gap-2 items-center pb-1.5 mb-1.5 border-b border-purple-500/20">
            ...
            <div className="grid grid-cols-2 gap-3 text-[9px] md:text-xs font-semibold uppercase tracking-wider">
            ...
            {colorGroups.map((group, idx) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Color name */}
                  <span className="text-gray-400 text-[10px] md:text-sm truncate">{group.colorName || 'Unknown'}</span>
                  
                  {/* Conditions aligned in columns - each clickable separately */}
                  <div className="grid grid-cols-2 gap-3 text-[10px] md:text-sm">
