  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="text-xs md:text-xs text-muted-foreground truncate">{sub}</p>
      </div>
  ...
  return (
    <div className="space-y-1">
      <div className="flex items-center justify-between gap-2">
        ...
        <span className={cn("text-xs font-mono", textColor)}>{Math.round(pct)}%</span>
      </div>
  ...
  return (
    ...
    >
      ...
      >
        ...
        {sub && <p className="text-xs md:text-xs text-muted-foreground truncate">{sub}</p>}
      </div>
  ...
  return (
    ...
    >
      ...
      >
        ...
        {stat && (
          <span className="text-xs font-mono shrink-0 truncate max-w-[110px]" style={{ color: `color-mix(in srgb, ${hex} 70%, #8899aa)` }}>{stat}</span>
        )}
        {/* Status dot */}
        {hasCritical ? (
          ...
          <div className="space-y-1">
            ...
            {!expanded && overflowCount > 0 && (
              <button
                ...
                className="text-[11px] font-mono text-muted-foreground/45 hover:text-muted-foreground/70 transition-colors text-left"
          ...
          >
            {validActions.map((a, i) => (
              <div key={i} className="flex items-center gap-1 min-w-0">
                ...
                <span className="text-[11px] text-muted-foreground/35 truncate">{a.label}</span>
                <span className={cn('text-[11px] font-mono shrink-0', a.ok ? 'text-green-500/50' : 'text-red-400/60')}>{a.time}</span>
              </div>
            ))}
          </div>
        )}
          ...
          <div className="space-y-1 pt-0.5" style={{ borderTop: `1px solid ${hex}18` }}>
            ...
            {forumPosts.slice(0, 3).map((p, i) => (
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  <p className="text-[11px] text-muted-foreground/55 truncate leading-tight">{p.title}</p>
          ...
          <div className="space-y-1 pt-0.5" style={{ borderTop: `1px solid ${hex}18` }}>
            ...
            {newsArticles.slice(0, 3).map((n, i) => (
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  <p className="text-[11px] text-muted-foreground/55 truncate leading-tight">{n.title}</p>
      ...
      <div className="px-3 py-2.5 border-t border-gray-700/30 bg-gray-900/40" data-testid="section-usage-synopsis">
        ...
        >
          ...
          <div className="flex items-center justify-between gap-2 mb-2">
            ...
            <span className="text-[11px] text-gray-600">{periodRange}</span>
          </div>
          ...
          <div className="space-y-1 mb-2">
            <div className="flex items-center justify-between gap-2">
              ...
              <span className="text-xs text-gray-300 font-mono tabular-nums">${(plan.basePrice / 100).toFixed(2)}</span>
            </div>
            <div className="flex items-center justify-between gap-2">
            ...
            {hasSalesFee && (
              <div className="flex items-center justify-between gap-2">
                <span className="text-xs text-purple-400/80">{plan.salesPercentage}% sales fee</span>
            ...
            return (
              <div className="px-3 pt-2 pb-3 border-t border-gray-700/30 bg-gray-900/40">
                <div className="flex items-center justify-between gap-2 mb-1">
                  ...
                  <span className={cn('text-xs font-mono font-bold tracking-widest', statusColor)}>
                    {statusLabel}
                  </span>
                </div>
                <FuelGauge remaining={remaining} />
                <div className="flex items-center justify-between gap-2 mt-1">
                  <span className="text-xs text-gray-600 font-mono">{used.toLocaleString()} used</span>
                  <span className="text-xs text-gray-600 font-mono">{(limit - used).toLocaleString()} left · rolling 24 h</span>
                </div>
              </div>
            );
          })()}
          ...
          <div className="bg-gray-950/60">
            {alerts.length > 0 && (
              <div className="px-3 pt-3 space-y-2">
                <h4 className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">Attention</h4>
                {alerts.map((a) => (
