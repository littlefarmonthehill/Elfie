...
export default function Home() {
  ...
  const renderActiveDrawer = () => {
    ...
    if (activeInventoryDrawer === 'warehouse') {
      return (
        <ToolDrawer icon={Warehouse} iconColor="text-emerald-400" title="Warehouse" onClose={closeActiveDrawer} contentClassName="flex-1 overflow-y-auto min-h-0">
          <WarehouseManagement />
        </ToolDrawer>
      );
    }
            ...
            <DrawerHeader className="p-0 flex-shrink-0">
              ...
              <div className="flex items-center gap-2 px-4 pt-2 pb-2 border-b border-gray-800">
                <DrawerTitle className="flex items-center gap-2 text-sm font-semibold text-gray-100 flex-1">
                  ...
                  {activeInventoryDrawer === 'warehouse' && <><Warehouse className="w-4 h-4 text-emerald-400 flex-shrink-0" /> Warehouse</>}
