  ...
  return (
    <div className="flex flex-col h-screen bg-background text-foreground">
        ...
        <div className="px-4 md:px-6 lg:px-8 py-2 md:py-3 lg:py-4 bg-black border-b border-gray-800">
          <div className="flex items-center gap-2 md:gap-3 lg:gap-4">
            <div className="flex items-center gap-1.5 md:gap-2 lg:gap-2.5">
              ...
              <span className="text-[11px] md:text-xs lg:text-sm font-bold text-gray-400">TOOLS</span>
            </div>
            <div className="flex gap-1.5 md:gap-2 lg:gap-2.5">
              <button
                onClick={() => setActiveInventoryDrawer('listing')}
                className="text-[10px] md:text-xs lg:text-sm font-bold py-1 md:py-1.5 lg:py-2 px-2 md:px-3 lg:px-4 rounded transition-all bg-gray-900 text-gray-400 border border-gray-700 hover-elevate"
          ...
          <div className="flex items-center gap-2 md:gap-3 lg:gap-4">
            ...
            <div className="flex gap-1.5 md:gap-2 lg:gap-2.5">
              <button
                ...
                className="relative text-[10px] md:text-xs lg:text-sm font-bold py-1 md:py-1.5 lg:py-2 px-2 md:px-3 lg:px-4 rounded transition-all bg-gray-900 text-gray-400 border border-gray-700 hover-elevate"
                data-testid="button-picklist"
              >
                Picklist
                {picklistStats && (picklistStats.toPull + picklistStats.toReshelve) > 0 && (
                  <span className="absolute -top-1 -right-1 md:-top-1.5 md:-right-1.5 bg-orange-500 text-white text-[9px] md:text-[10px] lg:text-[11px] font-bold rounded-full h-4 w-4 md:h-5 md:w-5 lg:h-6 lg:w-6 flex items-center justify-center">
              ...
              >
                ...
                {fulfillmentStats && fulfillmentStats.unfulfilled > 0 && (
                  <span className="absolute -top-1 -right-1 md:-top-1.5 md:-right-1.5 bg-green-500 text-white text-[9px] md:text-[10px] lg:text-[11px] font-bold rounded-full h-4 w-4 md:h-5 md:w-5 lg:h-6 lg:w-6 flex items-center justify-center">
      ...
      {(activeDashboard === 'sales' || activeDashboard === 'marketing') && (
        <div className="px-4 md:px-6 lg:px-8 py-2 md:py-3 lg:py-4 bg-black border-b border-gray-800">
          <div className="flex items-center gap-2 md:gap-3 lg:gap-4">
            <span className="text-[11px] md:text-xs lg:text-sm font-bold text-gray-400">DATE RANGE</span>
