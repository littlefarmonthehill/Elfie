...
- **AI Intelligence & Embeddings Management (Settings):** Provides an interface for managing embeddings, including statistics dashboard, batch embedding generation (configurable batch size), and a semantic search testing interface. OpenAI API key configuration is handled here.
