...
- **Automation & Scheduling:** Centralized controls for automated Inventory Sync, Price-o-Matic, Orders Sync, and BrickLink Forum Sync. Forum sync automatically scrapes BrickLink discussion forum posts, stores them with metadata (title, author, timestamps, URLs), and generates vector embeddings for AI-powered semantic search.
