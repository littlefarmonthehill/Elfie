...
- **AI Assistant (E.L.F.I.E.):** Uses OpenRouter (GPT-4o-mini) with `localStorage` and a `conversations` table for memory, leveraging RAG with PostgreSQL `pgvector` embeddings and OpenAI `text-embedding-3-small`.
