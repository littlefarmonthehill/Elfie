...
-   **Customer Shopping Platform:** A mobile-first storefront at `/shop` with a compact sticky header, search bar, and product grid, designed as a strategic alternative to Shopify.
